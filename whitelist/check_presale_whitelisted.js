...
const MenloTokenPresaleABI = require("../build/contracts/MenloTokenPresale.json").abi;
...
let MenloTokenPresale = new web3.eth.Contract(MenloTokenPresaleABI, MENLOTOKEN_PRESALE_ADDRESS);
...
const checkWhitelisted = async address => {
  ...
  try {
    ...
    isWhitelisted = await web3.eth.call({
      ...
      data: MenloTokenPresale.methods.whitelist(address).encodeABI()
    });
